            ...
            <div class="d-none">
                ...
                <div class="form-group">
                    ...
                    <form method="POST" action="/file-upload" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <button type="button" class="btn btn-info all_upload mt-4">Upload all files</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button type="button" id="view_image" class="btn btn-primary btn-block mt-5 shadow-none " data-toggle="modal" data-target="#viewImage" disabled>View image</button>
                    </div>
                </div>
                <!-- <div class="form-group">
                    <div id="demo-basic">
                ...
                <div class="form-group main_file_row">
                    <label class="form-label text-dark">Main File(zip,rar)(after buy download)</label>
